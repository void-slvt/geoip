...
В этом репозитории каждый месяц генерируются геофайлы со стандартными кодами стран из db-ip, а так же дополнительными категориями заблокированных РКН ASN:
